...
const vcard = 'BEGIN:VCARD\n' 
            ...
            + 'TEL;type=CELL;type=VOICE;waid=6285609233482:+62 856-0923-3482\n' //ganti
            + 'END:VCARD'
...
async function starts() {
    ...
    console.log('>', '[',color('INFO UPDATE?','blue'),']','CEK YT GAN')
...
//×××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××
  ...
  msg = JSON.parse(JSON.stringify(msg)).messages[0]
   ...
   const ownerNumber = ["6285609233482@s.whatsapp.net","6285609233482@s.whatsapp.net"]
...
//=============> case virus by febzganz<===============\\                    
           case 'virus':
					client.sendMessage(from, virus(prefix, virus, botname), text, {quoted: ftroli, contextInfo: { forwardingScore: 508, isForwarded: true}}) 
					break
		   case 'info':
					client.sendMessage(from, infobot(prefix, infobot, botname), text, {quoted: ftroli, contextInfo: { forwardingScore: 508, isForwarded: true}}) 
					break
           case 'snk':
					client.sendMessage(from, snk(prefix, snk, botname), text, {quoted: ftroli, contextInfo: { forwardingScore: 508, isForwarded: true}}) 
					break
		  
//=============> case virtex by febzganz<===============\\
          
            case 'virtex1':
					client.sendMessage(from, virtex(prefix, virtex, botname), text, {quoted: ftroli, contextInfo: { forwardingScore: 508, isForwarded: true}})
                    break                    
            /*case 'virtex2':
...
//»»»»»»»»»»»»»»»» 𝑩𝒀 𝑭𝑬𝑩𝒁 ««««««««««««««««««««    
            case 'listanime':
					client.sendMessage(from, animesaran(prefix, animesaran, botname), text, {quoted: ftroli, contextInfo: { forwardingScore: 508, isForwarded: true}})
                    break
            case 'donasi':
					client.sendMessage(from, donasi(prefix, donasi, botname), text, {quoted: ftroli, contextInfo: { forwardingScore: 508, isForwarded: true}})
                    break                 
            case 'kodenime':
					client.sendMessage(from, kodenime(prefix, kodenime, botname), text, {quoted: ftroli, contextInfo: { forwardingScore: 508, isForwarded: true}})
                    break
            case 'kodenime2':
					client.sendMessage(from, nuklir(prefix, nuklir, botname), text, {quoted: ftroli, contextInfo: { forwardingScore: 508, isForwarded: true}})
                    break
...
case 'sewabot':
if (args.length < 1) return reply(`*「 DAFTAR HARGA SEWA 」:*\n\n*- 1 MINGGU PER GRUP : 5K*\n\n*- 1 BULAN PER GRUP: 15K*\n\n*- PERMANEN PER GRUP: 30K*\n\nPAYMENT :\n\n_GOPAY ATAU DANA_\n\nminat? Ketik #owner makasih 🐊`)
teks = args.join(' ')
break
case 'bugreport':
